...
Spree::Page.create!(name: 'Conditions Générales de Ventes', slug: 'conditions-generales-de-ventes')
Spree::Page.create!(name: 'Mentions légales', slug: 'mentions-legales')
